...
| **Equivalent manual cost** | 320,000 THB (40 man-days)      |
...
Base case:
  Cost saved  = 320,000 - 3,100 = 316,900 THB
...
| Senior engineer (solo)   | 40       | 320,000               | 103x more      |
...
| ------------------- | ----------------- | ------------------------- |
| Initial development | 320,000           | 3,100                     |
