...
> ดู [CHANGELOG.md](CHANGELOG.md) สำหรับรายละเอียดทั้งหมด (v1.0.0 → v2.6.1)

### v2.6.1 — Custom OWASP Rules (A01/A03/A10), 3 New MCP Tools, PDF/CSV (Latest)
...
| [CHANGELOG.md](CHANGELOG.md)                                    | Version history (v1.0.0 → v2.6.1)                  |
...
| v2.6.1  | **Current** | CI/CD           | GitHub Actions, GitLab CI, SARIF per-tool, MCP bundle, tech debt |
